        ...
        >
            ...
            >
                ...
                <motion.button
                    ...
                    className='sm:text-lg text-white bg-black px-12 py-2.5 flex items-center gap-2 rounded-full'
                ...
                <motion.button
                    ...
                    className='sm:text-lg text-white bg-blue-600 px-12 py-2.5 flex items-center gap-2 rounded-full'
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                >
                    Generate Videos 🎥
